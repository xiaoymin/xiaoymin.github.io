---
layout: post
title: Kettle实战100篇 第1篇 调用RESTful接口导入JSON结果入库
categories: Kettle实战
description: Kettle实战100篇 第1篇 调用RESTful接口导入JSON结果入库
...
![](/images/kettle/kettle1/kia-json-1.png)
...
![](/images/kettle/kettle1/kia-json-2.png)

#### 配置REST client组件

设定好请求接口变量，接下来选择发送RESTFul的组件，因为我们是请求的接口,因此可以直接选择**REST client**组件

![](/images/kettle/kettle1/kia-json-3.png)
...
![](/images/kettle/kettle1/kia-json-4.png)

![](/images/kettle/kettle1/kia-json-5.png)
...
![](/images/kettle/kettle1/kia-json-6.png)
...
![](/images/kettle/kettle1/kia-json-7.png)
...
![](/images/kettle/kettle1/kia-json-8.png)

此时,我们点击工具栏的运行按钮，运行我们的ETL转换

![](/images/kettle/kettle1/kia-json-9.png)

![](/images/kettle/kettle1/kia-json-10.png)

运行，查看控制台日志输出

![](/images/kettle/kettle1/kia-json-11.png)

我们在查看我们的数据库,是否已经插入成功

![](/images/kettle/kettle1/kia-json-12.png)
...
![](/images/kettle/kettle1/kia-json-13.png)
...
![](/images/kettle/kettle1/kia-json-14.png)
...
![](/images/kettle/kettle1/kia-json-15.png)
...
![](/images/kettle/kettle1/kia-json-16.png)
...
![](/images/kettle/kettle1/kia-json-17.png)
...
![](/images/kettle/kettle1/kia-json-18.png)

此时,我们点击执行，查看我们的日志和数据库，如下图：

![](/images/kettle/kettle1/kia-json-19.png)

通过控制台,我们已经看到是成功的，再看我们的数据库

![](/images/kettle/kettle1/kia-json-20.png)
...
![](/images/kettle/kettle1/kia-json-21.png)
...
![](/images/kettle/kettle1/kia-json-22.png)
...
![](/images/kettle/kettle1/kia-json-23.png)

而我们的获取变量 组件 如下图：

![](/images/kettle/kettle1/kia-json-24.png)
...
![](/images/kettle/kettle1/kia-json-25.png)
